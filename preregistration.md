...
- **Stimuli**: Black squares on a white background
  ...
  - Comparison squares: 39 different sizes ranging from 8.00 to 15.00 sq.mm (We randomly generated the size of the comparison squares from a uniform distribution)
